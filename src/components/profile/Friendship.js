...
function Friendship({ friendshipp }) {
  ...
  const cancelRequestHandler = async () => {
    ...
    await dispatch(rejectFriendInvitation({ profileId: profileid }));
  };

  const followHandler = async () => {
    setFriendship({ ...friendship, following: true });
    await dispatch(follow(profileid));
  };

  const unfollowHandler = async () => {
    setFriendship({ ...friendship, following: false });
    await dispatch(unfollow(profileid));
  };
  ...
  const acceptRequestHanlder = async () => {
    ...
    await dispatch(acceptFriendInvitation({ id: profileid }));
  };
